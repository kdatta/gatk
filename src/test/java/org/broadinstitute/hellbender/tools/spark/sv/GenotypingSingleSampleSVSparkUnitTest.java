 ...
 */
public class GenotypingSingleSampleSVSparkUnitTest {

    @Test
    public void testMakeJunctionFilter(){

    }

    @Test
    public void testFilterJunctions(){
    ...
    @Test
    public void testMapAssemblyID2ItsAlignments(){
